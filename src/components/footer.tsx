...
const Footer = () => {
  return (
    <footer className="py-6 mt-10 bg-white max-w-screen-2xl overflow-x-hidden mx-auto w-full">
      ...
      <div className="container mx-auto px-4 max-w-[1200px] mt-10">
        ...
        <div className="mt-16 text-left bg-[#FAFAFA] py-9">
          <p className="text-[#737373] font-bold text-[14px]">Create this website is Hafiz Muhammad Umar. All Rights Reserved</p>
        </div>
      </div>
    </footer>
  );
